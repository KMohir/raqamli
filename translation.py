translations={
    ...
    'ru':{
        ...
        "Yo'nalishni yozing":"Напишите направление",
        "Su'niy intelekt":"Искусственный интеллект",
        "Kiberxavsizlik":"Кибербезопасность",
        "Tadbirkorlik va Moliya":"Предпринимательство и финансы",
        "O'yin sanoati":"Игровая индустрия",
        "Boshqa":"Другой",
        "Erkak":"Мужчина",
        "Ayol":"Женщина",
        "Jinsi":"Пол",
        "Oʻzingiz haqizda aytib bering":"Расскажи о себе",
        "Anketa_shabloni.docx":"Шаблон_анкеты.docx",
        "Yuqoridagi shablonni yuklab oling, uni toʻldiring va shu yerga yuklang":"Загрузите шаблон выше, заполните его и загрузите здесь",
        "Sizni arizangiz yuborildi":"Ваша заявка отправлена",
        "Ariza qoldirish":"Оставить заявку",
        "Word file ni yuboring":"Oтправьте файл word",
        "Hududni tanlang":"Выберите область",
        "Andijon viloyati":"Андижанская область",
        "Buxoro viloyati":"Бухарская область",
        "Fargʻona viloyati":"Ферганская область",
        "Jizzax viloyati":"Ферганская область",
        ...
        "Sirdaryo viloyati":"Самаркандская область",
